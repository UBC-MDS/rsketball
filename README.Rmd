...
For a more detailed understanding of the functions and their use cases, please refer to the [package vignette](https://github.com/UBC-MDS/rsketball/tree/master/vignettes).
